...
HD_PWD='D:/Projects/SOC_Projects/Counter_LedSwitch_Zedboard/Counter_LedSwitch_Zedboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqSystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZynqSystem_wrapper.tcl -notrace
