...
HD_PWD='D:/Projects/SOC_Projects/Counter_LedSwitch_Zedboard/Counter_LedSwitch_Zedboard.runs/ZynqSystem_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqSystem_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZynqSystem_processing_system7_0_0.tcl
