...
HD_PWD='D:/Projects/SOC_Projects/Counter_LedSwitch_Zedboard/Counter_LedSwitch_Zedboard.runs/ZynqSystem_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZynqSystem_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZynqSystem_xbar_0.tcl
